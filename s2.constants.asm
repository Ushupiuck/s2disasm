...
PLCID_001z1 =		id(PLCptr_001z1) ; 6
PLCID_001z2 =		id(PLCptr_001z2) ; 8
PLCID_Wz1 =		id(PLCptr_Wz1) ; 6
PLCID_Wz2 =		id(PLCptr_Wz2) ; 8
PLCID_003z1 =		id(PLCptr_003z1) ; A
PLCID_003z2 =		id(PLCptr_003z2) ; B
...
PLCID_009z1 =		id(PLCptr_009z1) ; 16
PLCID_009z2 =		id(PLCptr_009z2) ; 17
...
Score:				ds.l	1	; 4 bytes
				ds.b	2	; $FFFFFE2A-$FFFFFE2F ; seems unused
...
ArtTile_ArtNem_FloatPlatform          = $0428
